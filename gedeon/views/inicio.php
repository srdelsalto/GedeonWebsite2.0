...
<html>
    <head>
        ...
        <meta name="description" content="Somos una compañía de seguridad y vigilancia modalidad, investigación privada, autorizada para realizar investigaciones sobre el estado y situación de personas naturales o jurídicas y/o sus bienes
              ...
              Nos encontramos bajo el control de la Superintedencia de Compañias, Ministerio De Defensa, Ministerio Del Interior, Comandancia De Policía y al Control de Organizaciones de Seguridad Privada (COSP) .
              ">
    ...
    <body>
		...
		</section> <!---COPYRIGHT TO SOCICON ICONS--->
        <!---<div>
            ...
            <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top" style="background-color: #000000; height: 4rem; opacity: 0.8">
                ...
                <div class="menu-logo">
                    <div class="navbar-brand">
                        <span class="navbar-logo">
                            <a href="index.php">
                                <img src="assets/images/logo-797x284.png" alt="Inicio" title="" style="height: 8rem;">
                            </a>
                        </span>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
                        <li class="nav-item"><a class="nav-link link text-light display-5 " href="#recursos">
                                Recursos
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link link text-light display-5" href="#nosotros">
                                Nosotros
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link link text-light display-5" href="#servicios">
                                Servicios
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link link text-light display-5" href="#contacto">
                                Contacto
                            </a>
                        </li>
                    </ul>
                ...
                <div class="col-md-12">
                    <div class="media-container-row">
                        <div class="mbr-figure m-auto" style="width: 65%;">
                            <img src="assets/images/i_800x664.jpg" alt="" title="">
                        </div>
                        <div class=" align-left aside-content">
                            <h2 class="mbr-title pt-2 mbr-fonts-style display-2">
                                <strong>Personería Jurídica</strong></h2>
                            <div class="mbr-section-text">
                                <p class="mbr-text mb-2 pt-3 mbr-light mbr-fonts-style display-5">
                                    <strong>Existencia Legal</strong></p>
                            </div>
                ...
                <div class="media-container-row pt-5 ">
                    ...
                    <div class="card p-3 col-12 col-md-6 col-lg-3">
                        <div class="card-wrapper">
                            ...
                            <div class="card-box">
                                <h4 class="card-title mbr-fonts-style display-5">
                                    <strong>Personas desaparecidas</strong></h4>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="wrapper">
                                    ...
                                    <div class="b-info b-mail">
                                        ...
                                        <p class="mbr-text align-left mbr-fonts-style display-7">
                                            investigaciones.gedeonec@gmail.com <br>
                                            investigacionesgedeon.gerencia@gmail.com <br>
                                        </p>
                                    </div>
                                </div>
                            </div>
